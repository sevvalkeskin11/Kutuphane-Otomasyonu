        ...
        >
          ...
          <div className="py-1 text-sm">
            ...
            >
              ...
              >
                <path
                  d="M15 17l5-5-5-5M20 12H9M12 21H6a2 2 0 01-2-2V5a2 2 0 012-2h6"
                  strokeWidth="1.8"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 border-b border-ink/5 bg-surface/90 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 md:px-6">
          ...
          >
            ...
            />
            <span className="hidden sm:inline">StackLib</span>
          </Link>
            ...
            {!isAuthenticated && (
              <>
                <NavLink
                  to="/giris"
                  className={({ isActive }) =>
                    `${navClass({ isActive })} inline-flex items-center gap-2`
                  }
                >
                  <svg
                    viewBox="0 0 24 24"
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `rounded-full px-3 py-1.5 text-sm font-semibold transition-colors ${
                    isActive
                      ? "bg-night text-white"
                      : "bg-night/10 text-night hover:bg-night/15"
                  }`
                }
              >
                Admin
      ...
      {!isAuthPage && (
        <footer className="border-t border-ink/5 bg-surface py-4 mt-auto">
          <div className="mx-auto max-w-6xl px-4 text-center text-xs text-ink/50 md:px-6">
            &copy; {new Date().getFullYear()} Modern Kütüphane Otomasyonu. Tüm
            hakları saklıdır.
